...
| `strict`                             | `boolean` | `false`     | When `true`, only allows requests to paths explicitly defined in the schema. Any path not defined in the schema will result in in a typescript error                                          |
