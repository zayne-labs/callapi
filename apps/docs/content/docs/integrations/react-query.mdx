...
This guide covers the essential patterns and best practices for using CallApi within [React Query](https://tanstack.com/query/v5/docs/framework/react), allowing you to use CallApi's many features alongside React Query's caching and synchronization capabilities.
