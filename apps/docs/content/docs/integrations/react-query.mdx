...
This guide covers essential patterns and best practices for using CallApi with [React Query](https://tanstack.com/query/v5/docs/framework/react), combining CallApi's features with React Query's caching and synchronization capabilities.
