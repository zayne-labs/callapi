...
description: Advanced TypeScript utilities and type helpers for CallApi
---

CallApi provides advanced TypeScript utilities for complex type scenarios and better type safety.
...
declare module "@zayne-labs/callapi" {
	interface Register {
		meta: {
			...
			requestId?: string;
			feature?: string;
			source?: "user-action" | "background" | "system";
