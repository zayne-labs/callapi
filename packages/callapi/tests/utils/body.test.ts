...
test("Body conversion utils - toQueryString converts objects to query strings and handles expansions", () => {
...
test("Body conversion utils - toQueryString handles special characters and empty values", () => {
	expect(toQueryString({ search: "hello world" })).toBe("search=hello+world");
	expect(toQueryString({})).toBe("");
});

test("Body conversion utils - toFormData converts plain objects with primitives to FormData", () => {
...
test("Body conversion utils - toFormData handles arrays and appends items with same key", () => {
...
test("Body conversion utils - toFormData handles Blob and File values", () => {
...
test("Body conversion utils - toFormData JSON stringifies nested objects", () => {
...
test("Body conversion utils - toFormData handles complex mixed data types", () => {
...
test("Body conversion utils - toFormData handles objects with null prototype", () => {
